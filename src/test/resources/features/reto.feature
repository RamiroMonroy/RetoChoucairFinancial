...
Scenario Outline: validate the creation of new users
  ...
  Examples:
    ...
    |    Juan    |  Pedroza | jp777@jp.com |  May  |  4  | 1984 | Cali | Colombia |   472      |     Apple    | iPhone 4S |    iOS 11.0.2   | Mipassword2022 | Mipassword2022  | Welcome to the world's largest community of freelance software testers! |
